      ...
      <table class="display">
        ...
        <tr>
          ...
          <td class="center"><?php if($prow['price'] == 0):?>
            <a href="javascript:void(0);" class="add-cart" id="item_<?php echo $prow['id'].':FREE';?>"> <img src="<?php echo SITEURL;?>/siri-assets/activate.png" alt="" title="<?php echo _UA_ACTIVATE;?>"/> </a>
            <?php else:?>
            <?php if($gatelist):?>
...
<?php echo $core->doForm("processUser","siri-ajax/controller.php");?> 
