...
<script type="text/javascript" src="<?php echo SITEURL;?>/siri-assets/jquery.js"></script>
<script type="text/javascript" src="<?php echo SITEURL;?>/siri-assets/jquery-ui.js"></script>
<script type="text/javascript" src="<?php echo SITEURL;?>/siri-assets/tables.js"></script>
<script type="text/javascript" src="<?php echo SITEURL;?>/siri-assets/global.js"></script>
<script type="text/javascript" src="<?php echo SITEURL;?>/siri-assets/cycle.js"></script>
<script type="text/javascript" src="<?php echo SITEURL;?>/siri-assets/flex.js"></script>
<script type="text/javascript" src="<?php echo THEMEURL;?>/master.js"></script>
<script type="text/javascript" src="<?php echo SITEURL;?>/siri-assets/fancybox/jquery.fancybox.pack.js"></script>
<script type="text/javascript" src="<?php echo SITEURL;?>/siri-assets/fancybox/helpers/jquery.fancybox-media.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo SITEURL;?>/siri-assets/fancybox/jquery.fancybox.css" media="screen" />
<?php if($core->eucookie):?>
<script type="text/javascript" src="<?php echo SITEURL;?>/siri-assets/eu_cookies.js"></script>
<script type="text/javascript"> 
    ...
    <div class="row grid_24">
      <div class="top-menu clearfix">
        ...
        <?php if($core->showlogin):?>
          ...
          &bull; <a href="<?php echo SITEURL;?>/siri-admin">Admin Panel</a>
          <?php endif;?>
          &bull;
          <?php if($user->fbid):?>
