  ...
  function loadEditor($field, $width = "100%", $height = "450", $var = "oEdit1")
  {
	  print '
		  <script type="text/javascript">
			...
			["CustomName1","modalDialog(\'admin/editor/scripts/common/paypal.htm\',350,270)","PayPal Button","btnPayPal.gif"],			
			["HTML5Video", "modalDialog(\'admin/editor/scripts/common/webvideo.htm\',750,550,\'HTML5 Video\');", "HTML5 Video", "btnVideo.png"],
			["NewsArticle", "modalDialog(\'admin/editor/scripts/common/webnews.htm\',750,550,\'News Articles\');", "News Articles", "btnVideo.png"]
			];
			'.$var.'.toolbarMode = 2;
			'.$var.'.groups=[
			...
			["grpMedia", "", ["Media", "FlashDialog", "YoutubeDialog", "HTML5Video", "BRK", "CustomTag", "CharsDialog", "Line", "NewsArticle"]]
			];
