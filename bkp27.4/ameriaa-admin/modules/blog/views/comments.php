    ...
    $(document).ready(function() {
        ...
        $('#comment_list').dataTable({
            ...
            },
            {
                ...
                "bSortable": false,
                "fnRender": function (oObj) {
                    var actionButtons = '<a class="show-tooltip" title="View blog" href="<?php echo SITEURL ;?>blog/details/'+oObj.aData[4]+'"><i class="fa fa-eye fa-fw m-r-xs"></i></a>\n\
                                         <a class="show-tooltip" title="Edit blog" href="<?php echo SITEURL ;?>blog/edit/'+oObj.aData[4]+'"><i class="fa fa-pencil fa-fw m-r-xs" ></i></a>\n\
                                         <a class="show-tooltip" title="Deletc blog" id="'+oObj.aData[4]+'" class="deleteme" url="<?php echo SITEURL; ?>blog/deleteBlog"><i class="fa fa-times fa-fw"></i></a>' ;
