    ...
    <div id="content" class="app-content" role="main">
      <div class="app-content-body ">
        <div class="bg-light lter b-b wrapper-md">
          <h1 class="m-n font-thin h3">Manage faculty</h1>
        </div>
                    ...
                    <div class="col-md-6 text-right">            
                      <div class="btn-group btn-align icons-top">
                          <a class="btn m-b-xs btn-sm btn-primary btn-addon show-tooltip action-links" title="Export faculty" 
                             href="<?php echo SITEURL; ?>faculty/getexcel"><i class="glyphicon glyphicon-export"></i>Export</a>
                          <a class="btn m-b-xs btn-sm btn-primary btn-addon show-tooltip action-links" title="Add new faculty" 
                             href="<?php echo SITEURL; ?>faculty/add"><i class="icon-plus"></i>Add</a>                         
                          <a class="btn m-b-xs btn-sm btn-danger btn-addon deleteme action-links show-tooltip" title="Delete selected" href="javascript:void(0);" id="" url="<?php echo SITEURL; ?>faculty/deleteFaculty">
...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function() {
        ...
        $('#faculty_list').dataTable({
            //"bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo SITEURL; ?>faculty/getFaculty",
            "sServerMethod": "POST",
            ...
            },
            {
                ...
                "bSortable": false,
                "fnRender": function (oObj) {
                    var actionButtons = '<a class="show-tooltip" title="View details" href="<?php echo SITEURL ;?>faculty/details/'+oObj.aData[5]+'"><i class="fa fa-eye fa-fw m-r-xs"></i></a>\n\
                                         <a class="show-tooltip" title="Edit faculty" href="<?php echo SITEURL ;?>faculty/edit/'+oObj.aData[5]+'"><i class="fa fa-pencil fa-fw m-r-xs" ></i></a>\n\
                                         <a title="Delete faculty"  id="'+oObj.aData[5]+'" class="deleteme" url="<?php echo SITEURL; ?>faculty/deleteFaculty"><i class="fa fa-times fa-fw"></i></a>' ;
    ...
    function changeStatus(id, facultyId, status) {
        var url= "<?php echo SITEURL; ?>faculty/changeStatus";
