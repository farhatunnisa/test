    ...
    $(document).ready(function() {
        ...
        $('#members_list').dataTable({
            ...
            },
            {
                ...
                "bSortable": false,
                "fnRender": function (oObj) {
                    var actionButtons = '<a class="show-tooltip" title="View details" href="<?php echo SITEURL ;?>members/details/'+oObj.aData[5]+'"><i class="fa fa-eye fa-fw m-r-xs"></i></a>\n\
                                         ...
                                         <a title="Delete faculty"  id="'+oObj.aData[5]+'" class="deleteme" url="<?php echo SITEURL; ?>members/deleteMember"><i class="fa fa-times fa-fw"></i></a>' ;                              
