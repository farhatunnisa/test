...
class Banners_Model extends Model {
    ...
    public function processGetBanners() {
        return $this->db->findAll("SELECT * FROM ".DB_PREFIX."banners ORDER BY banner_id DESC");
    }
