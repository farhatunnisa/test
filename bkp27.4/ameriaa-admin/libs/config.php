...
define("SITEURL", "http://" . $_SERVER['HTTP_HOST'] . '/ameriaa/ameriaa-admin/');
define("URL", "http://" . $_SERVER['HTTP_HOST'] . str_replace("index.php/", "", $_SERVER['REQUEST_URI']));
define('BASE', $_SERVER['DOCUMENT_ROOT']."/ameriaa/ameriaa-admin/");
define('PATH', "http://".$_SERVER['HTTP_HOST']."/ameriaa/ameriaa-admin/");
...
define("DIRECT", true);
//define("FRONTURL", "http://" . $_SERVER['HTTP_HOST'] . '/dcard/');
//define("FRONTURLBASE", $_SERVER['DOCUMENT_ROOT'] . '/dcard/');
//define("SITEDATA", "http://" . $_SERVER['HTTP_HOST'] . '/dcard/');
//define("IMAGEURL","http://" . $_SERVER['HTTP_HOST'] . '/dcard/');
//define("IMAGEPATH", $_SERVER['DOCUMENT_ROOT']."/dcard/");
