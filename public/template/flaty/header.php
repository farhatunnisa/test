...
<link rel="stylesheet" href="<?php echo THEMEURL;?>css/accordion.css" type="text/css"/>
<link rel="stylesheet" href="<?php echo THEMEURL;?>css/carousel.css" type="text/css" />
<link rel="stylesheet" href="<?php echo THEMEURL;?>css/prettyphoto.css" type="text/css">
...
<![endif]-->
<link rel="stylesheet" href="<?php echo THEMEURL;?>css/tabs.css" type="text/css"/>
...
<script type="text/javascript" src="<?php echo THEMEURL;?>js/prettyphoto.js"></script> 
...
<div class="wrapper"> 
  ...
  <header>
    <div class="topSection">
      <div class="pageWidth">
        <div class="headLeft wow fadeInUp animated"><a href="<?php echo SITEURL;?>"><img src="<?php echo THEMEURL;?>images/logo.png" alt="logo" title="logo -  home" /></a></div>
        <div class="headRight wow fadeInDown animated">
          <ul>
            <?php if($this->session->gets('ameriaa_user_id') == '') { ?>
                ...
                <div class="loginForm"> <span class="arrowUp"></span>
                  <form method="post" name="login" id="login_form" >
                    ...
                    <dl>
                      ...
                      <dd><a href="<?php echo SITEURL;?>forgetpassword">Forgot&nbsp;Password?</a></dd>
                    </dl>
                    <div class="clear"></div>
                  </form>
                </div>
              ...
              <li>
                <button type="submit" value="" class="btn btnCharcol" onClick="window.location='<?php echo SITEURL;?>registration'"><i class="icon-user"></i><span>Register</span></button>
              </li>
            <?php } else {  ?>
              <li> 
                <a class="dropdown-toggle" href="javascript:void(0)"> 
                  <img src="<?php echo IMAGEURL; ?>uploads/members/<?php echo $this->session->gets('image')?>" alt="user"> <span><?php echo $this->session->gets('user_name'); ?></span> 
            ...
            <div class="menu">
              <div class="pageWidth">
                <nav> 
                  ...
                  <ul>
                    <li><a class="<?php if($this->getUrl(2) == 'index' || $this->getUrl(2) == ''){ echo 'active'; } ?>" href="<?php echo SITEURL;?>">Home</a></li>
                    ...
                    <li><a class="<?php if($this->getUrl(2) == 'membership'){ echo 'active'; } ?>" href="<?php echo SITEURL ;?>membership">Membership</a></li>
