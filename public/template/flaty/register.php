    ...
    <div class="innerContent">
      <div class="pageWidth">
        <div class="registration">
          <form id="SignupForm" method="post" action="<?php echo SITEURL;?>registration/registerdetails" enctype="multipart/form-data" autocomplete="off">
            <ul id="steps">
              ...
              <div class="regsterDiv">
                ...
                <ul>
                  <li>
                    ...
                    <div>
                      <input type="text" class="textBox" id="license" name="license_number" placeholder="Enter medical licence number"/>
                    </div>
                  </li>
                  <li>
                    <div>Expiry Date</div>
