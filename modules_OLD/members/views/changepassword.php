    ...
    <div class="pageWidth dashboard">
      <div class="sidebar">
        <ul class="userAccount">
          <li><a>
            <div><img src="<?php echo THEMEURL;?>images/user.jpg" alt="user" /></div>
            <h2>Lorem ipsum dolor</h2>
            <span>Aesthetic Medicine</span> <span>Alexandria, Egypt</span> </a> </li>
        </ul>
            ...
            <div class="regsterDiv dashDetails cpw">
              ...
              <ul>
                <li>
                  ...
                  <div>
                    <input type="password" class="textBox" name="oldpwd" id="oldpwd" value="<?php echo $this->PasswordDetails['password'];?>"/>
                  </div>
                </li>
              </ul>
              <ul>
