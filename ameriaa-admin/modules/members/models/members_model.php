...
class members_model extends Model {
    ...
    */
    ...
    public function courses($id){
        $sql = "SELECT c.course_title,f.faculty_name,c.start_date,c.end_date 
                FROM ".DB_PREFIX."members as m 
                INNER JOIN ".DB_PREFIX."member_courses as mc 
		ON m.member_id = mc.user_id 
                INNER JOIN ".DB_PREFIX."courses as c 
                ON mc.course_id=c.course_id INNER JOIN ".DB_PREFIX."faculty as f 
		ON f.faculty_id = c.faculty_id WHERE  m.member_id = '$id'";
