...
* 
* @package    gallery
* @author farhat <farhat.unnisa@siriinnovations.com>
* @version    1.0
...
class Gallery_Model extends Model {
    ...
    */
    ...
    public function processGalleryImagesUpload($data) {
        ...
        $dataIn['image_thumb']    = $data['image_thumb'];
    ...
    /**
     * processGalleryImagesDataUnlink()
     * @param type $id
     * @return type
     */
