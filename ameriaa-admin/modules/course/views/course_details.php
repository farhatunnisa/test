      ...
      <div class="app-content-body ">
        <div class="bg-light lter b-b wrapper-md breadcrumb-nav">          
          <ul class="movingrowlinks">	
            ...
            <li><a title="Details Course" style="cursor: auto;">Course details</a></li>
          </ul><br>
        </div>
                ...
                <div class="rightarea"> 
                  <div class="col-md-9 user-profile-info usr-profile">
                    <ul>
                      ...
                      <li class="even"><span>Discount :</span><?php echo $this->coursrDetaisl['discount'];?></li>
                      <li class="odd"><span>Short description:</span> <?php echo $this->coursrDetaisl['short_desc']; ?></li>
                      <li class="even"><span>How many days:</span><?php echo $this->coursrDetaisl['full_desc'];?></li>                      
                    </ul>
                  </div>
                </div>                             
              </div>                
