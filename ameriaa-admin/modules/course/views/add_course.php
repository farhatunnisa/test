            ...
            <div class="panel-body">
              <form id="validation-form" class="form-horizontal" action="<?php echo SITEURL; ?>course/addCourseDetails" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="course_name" name="course_name" placeholder="Enter course name" data-rule-required="true" data-rule-minlength="3" data-rule-maxlength="100">
                  </div>
                </div>                  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="location" name="location" placeholder="Enter your location" data-rule-required="true" data-rule-minlength="3" data-rule-maxlength="50">
                  </div>
                </div>                  
                <div class="line line-dashed b-b line-lg pull-in"></div>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="no_of_days" name="no_of_days" placeholder="number Only" 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="member_fee" name="member_fee" placeholder="Enter member fee" data-rule-required="true"
                           data-rule-number="true" data-rule-maxlength="7">
                  </div>
                </div>                  
                <div class="line line-dashed b-b line-lg pull-in"></div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="non_member_fee" name="non_member_fee" placeholder="Enter non member fee" 
                           data-rule-required="true" data-rule-number="true" data-rule-maxlength="7">
                  </div>
                </div>                  
                <div class="line line-dashed b-b line-lg pull-in"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">                        
                      <select ui-jq="chosen" class="form-control m-b"  multiple class="w-md" id="faculty_name" name="faculty_name[]" data-rule-required="true">
