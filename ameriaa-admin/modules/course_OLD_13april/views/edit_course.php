            ...
            <div class="panel-body">
              <form id="validation-form" class="form-horizontal" action="<?php echo SITEURL; ?>course/updateCourseDetails" method="post" enctype="multipart/form-data">
                  ...
                  for($i = 1; $i<=$count; $i++){ ?>
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-id-1">Day <?php echo $i; ?></label>
                        <div class="col-sm-10">
                          <textarea id="body_content" name="full_desc[]" rows="4" cols="30"><?php echo $data[$j]; ?></textarea>
                            ...
                            // <![CDATA[
                                ...
                                window["oEdit" + id].REPLACE("body_content");
                                // ]]>
                         </script>
                        </div>
                    </div>                  
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">                        
                      <select ui-jq="chosen" multiple class="w-md" id="faculty_id" name="faculty_id[]">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control span2" id="date-range0" name="date" 
                               data-rule-required="true" value="<?php echo date('m/d/Y', strtotime($this->coursrDetails['start_date'])). " to " . date('m/d/Y', strtotime($this->coursrDetails['end_date'])); ?>">
                    </div>
                </div>
                <div class="line line-dashed b-b line-lg pull-in"></div>
