  ...
  <div id="main-content"> 
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          <div class="box-title">
            <h3><i class="icon-picture"></i>Event Photos</h3>
          ...
          <div class="box-content frms">
            <div class="clearfix">
                ...
                <div class="pull-right">
                    <div class="btn-toolbar">
                        <div class="btn-group">
                              <?php if(in_array($this->photosModuleId, $permissions['add'])) { ?>
            ...
            <div class="box-content frms" id="upload-dropzone-area" style="display: none;">                
                <div id="my-awesome-dropzone" class="dropzone hidden-xs dz-clickable" action="<?php echo SITEURL; ?>events/eventPhotosUpload/<?php echo $this->event_id; ?>">
                        ...
                        this.on("complete", function (file) {
                            if (this.getUploadingFiles().length === 0 && this.getQueuedFiles().length === 0) {
                              ...
                              location.reload();
                                /*$.ajax({
                                    type: "POST",
                                    url: "<?php echo SITEURL; ?>events/photosRefresh/<?php echo $this->event_id; ?>",
    ...
    <div class="modal-dialog">
        <div class="modal-content changepassword">
          ...
          <div class="modal-body frms">
              <form id="photoinfo" action="<?php echo SITEURL; ?>events/eventPhotosTitles">                            
...
<div class="modal fade" id="myModal-Delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content changepassword">
          ...
          <div class="modal-body frms">
              <form id="photodelete" action="<?php echo SITEURL; ?>events/eventPhotosDelete">                            
                  <div class="form-group">
                      <div class="col-lg-12 controls">                          
