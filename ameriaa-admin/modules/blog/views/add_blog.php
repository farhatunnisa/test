      ...
      <div class="app-content-body ">
        <div class="bg-light lter b-b wrapper-md breadcrumb-nav">          
          <ul class="movingrowlinks">	
            ...
            <li><a href="javascript:void(0)" title="Add blog" style="cursor: auto;">Add Blog</a></li>
          </ul><br>
        </div>
        ...
        <div class="wrapper-md">
          <div class="panel panel-default">            
            ...
            <div class="panel-body">
              <form id="validation-form" class="form-horizontal" action="<?php echo SITEURL; ?>blog/addBlogDetails" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-id-1">Blog name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="blog_name" name="blog_name" placeholder="Enter blog name" data-rule-required="true" data-rule-minlength="3">
                  </div>
                </div>                  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea id="body_content" name="full_desc" rows="4" cols="30"></textarea>
