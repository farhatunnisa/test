...
<script type="text/javascript" src="siri-assets/jquery.js"></script>
<script type="text/javascript" src="siri-assets/jquery-ui.js"></script>
<script type="text/javascript" src="siri-assets/tooltip.js"></script>
<script type="text/javascript" src="siri-assets/global.js"></script>
<link href="siri-assets/redmond/jquery-ui.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
// <![CDATA[
  $('#maindata').on('click', 'a.getfile', function () {
	  var URL = 'editor/uploads/' + $(this).attr('data-path');
