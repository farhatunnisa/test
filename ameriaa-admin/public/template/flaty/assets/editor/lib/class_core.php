<?php
  ...
  class Core
  {
	  ...
	  public function processConfig()
	  {
		  ...
		  if (empty($this->msgs)) {
              ...
              if (isset($_POST['dellbgimg']) and $_POST['dellbgimg'] == 1) {
				  ...
				  if ($this->bgimg) {
					  @unlink(WOJOLITE . "siri-theme/". $this->theme . "/images/" . $this->bgimg);
				  }
					  move_uploaded_file($_FILES['bgimg']['tmp_name'], WOJOLITE . "siri-theme/". $this->theme . "/images/" . $_FILES['bgimg']['name']);
	  ...
	  public function renderThemeBg()
	  {
		  ...
		  if($this->bgimg) {
			  $css .= 'background-image: url(' . SITEURL . '/siri-theme/' . $this->theme . '/images/' . $this->bgimg . ');';
		  ...
		  if (empty($this->msgs)) {
			  ...
			  if($getplugindata) {
				  foreach($getplugindata as $pdata) {
					  $plangdata = WOJOLITE . 'siri-admin/plugins/'.$pdata['plugalias'].'/lang-delete.php';
			  ...
			  if($getmoduledata) {
				  foreach($getmoduledata as $mdata) {
					  $mlangdata = WOJOLITE . 'siri-admin/siri-modules/'.$mdata['modalias'].'/lang-delete.php';
	  ...
	  public function addLanguage()
	  {
		  ...
		  if (empty($this->msgs)) {
			  ...
			  if($getplugindata) {
				  foreach($getplugindata as $pdata) {
					  $plangdata = WOJOLITE . 'siri-admin/plugins/'.$pdata['plugalias'].'/lang-add.php';
					  if(is_file($plangdata)) {
						  include_once($plangdata);
					  }
				  }
			  ...
			  if($getmoduledata) {
				  foreach($getmoduledata as $mdata) {
					  $mlangdata = WOJOLITE . 'siri-admin/siri-modules/'.$mdata['modalias'].'/lang-add.php';
					  if(is_file($mlangdata)) {
						  include_once($mlangdata);
					  }
				  }
	  ...
	  {
		  $options = glob("" . WOJOLITE . "/siri-theme/" . $themename . "/skins/*.css");
