  ...
  <div class="pageWidth dashboard">
    <div class="sidebar">
      ...
      <ul class="accountList">
          ...
          <li><a href="<?php echo SITEURL.'members/editdetails';?>">
      ...
      <div class="dashboardInfo">
        <div class="dashboardInner">
              <?php $success = $this->session->gets('success');
                    $faillure = $this->session->gets('faillure');?>
          ...
          <form id="myprofile">
            <div class="dashDetails regsterDiv profileInfo rowSpace">
              ...
              <ul>
                <li>
                  <div>Country:</div>
                  <div> <?php echo $this->memberDetails['country_name']; ?> </div>
                </li>
                <li>
                  <div>State:</div>
            ...
            <div class="regsterDiv dashDetails profileInfo rowSpace">
              ...
              <ul>                
                <li>
                  ...
                  <div> 
                      <?php 
                        $date = $this->memberDetails['expiry_date'];
              ...
              <ul>                
                ...
                <li>
                  ...
                  <div> <?php if($this->memberDetails['field_of_practice'] == "Both"){ 
                                echo "Aesthetic Medicine, Aesthetic Surgery" ;
                              } else {
                                echo $this->memberDetails['field_of_practice'];
                              }
                        ?> </div>
                </li>
              </ul>
