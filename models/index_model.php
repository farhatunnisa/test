...
//        print_r($data);exit;
        ...
        $dat = str_replace('/', '-', $data['course_date']);
...
//        } 
        ...
        $query = " SELECT * FROM sg_courses WHERE course_id = '$courseId' AND start_date = '$date'";
    ...
    public function checkEmail($data) {
        $result = $this->db->findAll('SELECT email FROM '.DB_PREFIX.'newsletter WHERE email = "'.$data['email'].'" ');
        return $result;
    }
